...
local Files = listfiles(string.format("%s/%s", "oreo.fun", tostring(game.PlaceId)))
...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/oncv/testing/main/sfg.lua"))()
Library:SetWatermark("oreo.fun")

local Window = Library:CreateWindow("oreo.fun")
